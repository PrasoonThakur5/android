package com.example.scanfood007;
...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void Texture(View Button) {

        if (startTexture == false) {
            startTexture = true;
        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraBridgeViewBase = (JavaCameraView)findViewById(R.id.camera_view2);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Imgproc.cvtColor(frame, frame, Imgproc.COLOR_BGR2HSV_FULL);
        ...
        if (startTexture == true) {

            Imgproc.cvtColor(frame, frame, Imgproc.COLOR_RGBA2GRAY);
            Imgproc.Canny(frame, frame, 300, 150);
